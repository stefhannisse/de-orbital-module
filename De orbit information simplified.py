...
de_orbit_time_limit = 10  # The maximum amount of years before the spacecraft is de-orbited
relative_de_orbit_factor = 5  # The factor in which the de-orbit time is reduced -> 50 years become 10 years with a factor of 5
calculate_relative_diameter = False  # Whether the diameter should be calculated relatively or as a constant value
beam_diameter = 32  # If relative diameter set to false, set the diameter manually(mm)
Boom_inclination_angle = np.pi / 6  # The angle in which the beams face upwards
...
if t_years >= relative_de_orbit_factor * de_orbit_time_limit:
    A_increase_factor = (t_years / de_orbit_time_limit) * CD_ratio
    A_needed = area * A_increase_factor * increase_factor
elif t_years < relative_de_orbit_factor * de_orbit_time_limit:
    A_needed = CD_ratio * relative_de_orbit_factor * area * increase_factor
...
if calculate_relative_diameter:
    Boom_diameter = 2 * np.sqrt(Boom_area / np.pi)
else:
    Boom_diameter = beam_diameter
